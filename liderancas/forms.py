...
from .models import Lideranca, Voluntario, Cidade, Regiao, InteracaoLog, Egresso, Lassberg
...
class EgressoForm(DuplicateCheckMixin, forms.ModelForm):
    ...
    def clean(self):
        super().clean()
        self._check_duplicates(Egresso.objects.all())
...
class LassbergForm(DuplicateCheckMixin, forms.ModelForm):
    ...
    def clean(self):
        super().clean()
        self._check_duplicates(Lassberg.objects.all())
        return self.cleaned_data
