"""
Django settings for crm_sorgatto project.
...
MIDDLEWARE = [
    ...
    'crm_sorgatto.middleware.RedirecionarUsuarioPWA',
]

ROOT_URLCONF = 'crm_sorgatto.urls'
...
WSGI_APPLICATION = 'crm_sorgatto.wsgi.application'
